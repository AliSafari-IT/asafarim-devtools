...
export default function Home() {
  ...
  return (
    <div className="overflow-y-auto h-full">
      {/* Top bar */}
      <div className="sticky top-0 z-10 bg-slate-900/95 backdrop-blur border-b border-slate-700/50 px-6 py-3 flex items-center justify-between">
        <div>
          <h1 className="text-sm font-semibold text-white">ASafariM DevTools</h1>
      ...
      <div className="px-6 py-8 border-b border-slate-800">
        <div className="max-w-2xl flex items-center gap-4">
          <img
            ...
            className="w-16 h-16 shrink-0 drop-shadow-xl"
          />
          <div>
        ...
        {/* Stats */}
        <div className="grid grid-cols-3 sm:grid-cols-5 gap-3 mt-6 max-w-2xl">
      ...
      {/* Footer */}
      <div className="px-6 py-6 border-t border-slate-800 text-center">
